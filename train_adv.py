...
def main():
    ...
    if args.wandb:
        ...
        wandb.init(project="RPF_With_SubAT", entity="fordepu-chongqing-university-of-post-and-telecommunications")
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train(train_loader, model, criterion, optimizer, lr_scheduler, epoch, args.rp)
...
def train(train_loader, model, criterion, optimizer, lr_scheduler, epoch, is_rp = false):
    """
    Run one train epoch
    """
