...
if args.wandb:
    ...
    wandb.init(project="RPF_With_SubAT", entity="fordepu")
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train(train_loader, model, criterion, optimizer, epoch, args.rp)
        lr_scheduler.step()
...
def train(train_loader, model, criterion, optimizer, epoch, is_rp = false):
    # Run one train epoch
