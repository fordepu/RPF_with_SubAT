...
CUDA_VISIBLE_DEVICES=$device python -u train_adv.py --pgd50  --wandb\
        ...
        --train_gamma 10 --test_gamma 2 --wd 0.0005 --arch ResNet18 \
        --epochs=150  --save-dir=$DST/models --log-dir=$DST --EXP $EXP \
        --rp --rp_block -1 -1 --rp_out_channel 48
...
CUDA_VISIBLE_DEVICES=$device python -u train_adv_psgd.py --autoattack \
        ...
        --arch=ResNet18 --epochs=40  --save-dir=$DST/models --log-dir=$DST --log-name=PSGD \
        --rp --rp_block -1 -1 --rp_out_channel 48
